...
Let's use `SCSS` syntax to describe such approach returning back to our first basic example, spiced up a little with CSS module system, but just a little:
